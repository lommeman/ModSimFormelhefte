...
\begin{abstract}
    ...
    \\ PS: there might be some muffins here
\end{abstract}
\vspace*{\fill}
...
\include{BondGraph}
\include{rigidbody}
\include{generalized_forces}
\include{state_space_formulations}
\include{Numeric simulation}
\include{DAE}
\include{extra_definitions}
...
\include{appendix for eksempler}
